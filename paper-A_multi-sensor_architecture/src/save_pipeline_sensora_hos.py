...
def gen_pipe_union():
    tf_selector_01 = load_selector('tf_selector_SENSORA_HOS_SF1' + '.pkl')
    tf_selector_02 = load_selector('tf_selector_SENSORA_HOS_SF2' + '.pkl')

    # scalers
    tf_scaler_01 = load_scaler('tf_scaler_SENSORA_HOS_SF1' + '.pkl')
    tf_scaler_02 = load_scaler('tf_scaler_SENSORA_HOS_SF2' + '.pkl')
