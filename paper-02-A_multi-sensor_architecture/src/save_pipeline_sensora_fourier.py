...
def gen_pipe_appended():
    tf_selector_01 = load_selector('tf_selector_SENSORA_FOURIER_SF1' + '.pkl')
    tf_selector_02 = load_selector('tf_selector_SENSORA_FOURIER_SF2' + '.pkl')

    # scalers
    tf_scaler_01 = load_scaler('tf_scaler_SENSORA_FOURIER_SF1' + '.pkl')
    tf_scaler_02 = load_scaler('tf_scaler_SENSORA_FOURIER_SF2' + '.pkl')
...
if __name__ == "__main__":
    ...
    full_pipeline = gen_pipe_appended()
