...
def gen_pipe_union():
    tf_selector_01 = load_selector('tf_selector_SENSORV_FOURIER_SF1' + '.pkl')
    tf_selector_02 = load_selector('tf_selector_SENSORV_FOURIER_SF2' + '.pkl')
    tf_selector_03 = load_selector('tf_selector_SENSORV_FOURIER_SF3' + '.pkl')
    tf_selector_04 = load_selector('tf_selector_SENSORV_FOURIER_SF4' + '.pkl')

    # scalers
    tf_scaler_01 = load_scaler('tf_scaler_SENSORV_FOURIER_SF1' + '.pkl')
    tf_scaler_02 = load_scaler('tf_scaler_SENSORV_FOURIER_SF2' + '.pkl')
    tf_scaler_03 = load_scaler('tf_scaler_SENSORV_FOURIER_SF3' + '.pkl')
    tf_scaler_04 = load_scaler('tf_scaler_SENSORV_FOURIER_SF4' + '.pkl')
